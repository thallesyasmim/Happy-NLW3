...
export default function OrphanageDetails() {
  ...
  function handleWhatsapp() {
    Linking.openURL(`https://api.whatsapp.com/send?phone=55${orphanage?.whatsapp}&text=Olá, tenho interesse em visitar o ${orphanage?.name}`);
  }

  function handleEmail() {
    MailComposer.composeAsync({
      subject: 'Interesse na Casa de Acolhimento de Crianças',
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <RectButton style={styles.contactButton} onPress={handleWhatsapp}>
          ...
          <Text style={styles.contactButtonText}>Contato pelo WhatsApp</Text>
        </RectButton>

        
        <RectButton style={styles.contactButtonEmail} onPress={handleEmail}>
          <FontAwesome name="envelope-o" size={24} color="#FFF" />
          <Text style={styles.contactButtonText}>Contato pelo E-mail</Text>
        </RectButton>
      </View>
    </ScrollView>
  )
